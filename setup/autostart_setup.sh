...
if ! grep -q "@lxterminal -e python3 /home/mister/Desktop/ABB_pi/main.py" /etc/xdg/lxsession/LXDE-pi/autostart; then
  # Füge die Zeile am Ende der Datei hinzu
  echo "@lxterminal -e python3 /home/mister/Desktop/ABB_pi/main.py" | sudo tee -a /etc/xdg/lxsession/LXDE-pi/autostart > /dev/null
